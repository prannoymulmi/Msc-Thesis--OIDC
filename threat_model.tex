...
\textbf{Definitions}:
    \begin{itemize}
       ...
       \begin{itemize}
           \item \textbf{1-5}: Very Low Risk
           \item \textbf{5-10}: Low Risk
           \item \textbf{10-15}: Medium Risk
           \item \textbf{15-20}: High Risk
           \item \textbf{20-25}: Very High Risk
       \end{itemize}
    \end{itemize}
