...
OAuth Tokens & Used to authorise access to resources for the user. \\
\hline
...
\textbf{Definitions}:
    \begin{itemize}
       ...
       \begin{itemize}
           ...
           \item \textbf{15-20}: High Risk = Risk needs to be mitigated immediately.
           \item \textbf{20-25}: Very High Risk = Risk needs to be mitigated immediately.
