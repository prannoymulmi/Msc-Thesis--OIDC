...
Legend:
    \begin{itemize}
        \item  \textbf{Likelihood (1-5)}: Likelihood of the attack happening based on the current environment, known vulnerabilities, and ease of exploitation. \newline
        1: Very unlikely \newline
        5: Very likely
...
\hline
\rowcolor{grey!15}
\textbf{Threat} & \textbf{Likelihood (1-5)} & \textbf{Impact (1-5)} & \textbf{Risk Level (1-25)} \\
\hline
\endfirsthead
...
ID Spoofing & 4 & 4 & 16 \\
\hline
Credential Stuffing & 4 & 3 & 12 \\
\hline
Phishing & 5 & 4 & 20  \\
\hline
Man-in-the-Middle (MITM) & 3 & 5 & 15 \\
\hline
Token Tampering & 3 & 5 & 15 \\
\hline
Code Injection (XSS, SQLi) & 3 & 4 & 12 \\
\hline
Malicious Endpoint & 2 & 5 & 10 \\
\hline
Ransomware & 2 & 5 & 10 \\
\hline
Action Denial (Denial of Service) & 4 & 3 & 12\\
\hline
Tenant Switching & 2 & 5 & 10 \\
\hline
Cross-tenant data Leakage & 3 & 5 & 15 \\
\hline
Token Exposure (Logging) & 3 & 4 & 12 \\
\hline
Cloud Misconfigurations & 4 & 5 & 20 \\
\hline
Token Bombing & 3 & 3 & 9 \\
\hline
API Rate Limiting Attack & 4 & 3 & 12 \\
\hline
Resource Starvation & 3 & 4 & 12\\
\hline
PKCE Downgrade Attack & 2 & 4 & 8 \\
\hline
Insecure Multi-Tenant Access Control & 3 & 5 & 15 \\
\hline

\end{longtable}

\subsection{Compliance Risk}